...
//    }  
//    
    //TEST 1 - Person comes into restaurant, restaurant has seating.
...
//
//            //PRECONDITIONS
//            assertEquals("Host should have zero customers", host.getCustomers().size(), 0);
//            assertEquals("Host should have zero waiters", host.getWaiters().size(), 0);
//            assertEquals("No tables should be occupied", host.tables.get(0).getOccupied(), false);
//            
//            //Add a Customer
//            host.msgCheckForASpot(customer);
//            
//            //Do checks
//            assertEquals("Host should have one customer", host.getCustomers().size(), 1);
//            assertEquals("Host should have no waiters", host.getWaiters().size(), 0);
//            assertEquals("The state should be waitingToSeeIfFull", host.customers.get(0).state, customerState.waitingToSeeIfFull);
//            
//            assertTrue("The host should have run an action.", host.pickAndExecuteAnAction());
            
            
            //PART 1 - Add a Customer
//            host.msgIWantFood(customer,  true);
